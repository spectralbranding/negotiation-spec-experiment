...
*Why*: the hash is the tamper-evidence record bound to the frozen preregistration (git
freeze commit 2ed95ffd + Zenodo archive). PREREGISTRATION §2 records the hash at the freeze.
...
**12. External pre-run timestamp recorded in `PREREGISTRATION.md`.**
*Why*: the preregistration is only meaningful if the external timestamp is verifiable.
The authoritative pre-run timestamp is the git freeze commit `2ed95ffd` (2026-06-06,
before the first paid call); it is archived third-party and timestamped on Zenodo
(concept DOI 10.5281/zenodo.20595996) and mirrored on GitHub. (An OSF node was originally
planned but is not used.)

**13. Prompt hash bound to the frozen preregistration.**
*Why*: PREREGISTRATION §2 binds the frozen `PROMPT_HASHES.txt` to the freeze commit /
Zenodo archive, preventing post-hoc prompt changes — the hash links the prompts to the
external timestamp.
...
| 12 | External pre-run timestamp in PREREGISTRATION.md | DONE | Git freeze commit 2ed95ffd (before first paid call) + Zenodo archive (10.5281/zenodo.20595996) provide the verifiable third-party timestamp. (OSF originally planned, not used.) | P0 |
| 13 | Prompt hash bound to the frozen preregistration | DONE | `PROMPT_HASHES.txt` bound to the freeze commit / Zenodo archive | P0 |
...
1. **External pre-run timestamp** — RESOLVED. The authoritative timestamp is the git
   freeze commit `2ed95ffd` (2026-06-06, before the first paid call), archived
   third-party and timestamped on Zenodo (concept DOI 10.5281/zenodo.20595996) and
